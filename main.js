...
// Avatar
const philTexture = new THREE.TextureLoader().load('./public/phil.JPG')
...
const normalTexture = new THREE.TextureLoader().load('./public/normaljpg')
...
function moveCamera() {
  ...
  phil.rotation.y += 0.01
  phil.rotation.z += 0.01
